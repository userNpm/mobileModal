...
(function (window, document, Math) {
  var mobileModal = {
    ...
    alert: function (content, callBack) {
      ...
      modalParent.firstChild.className = 'layui-m-anim-scale'
      // 点击事件
    ...
    toast: function (content) {
      ...
      var toastDiv = document.createElement('div') // 父节点
      toastDiv.className = 'toast-box' // classname
      var toastP = document.createElement('p') // 子节点p
      var Pnode = document.createTextNode(content) // text文本

      toastP.appendChild(Pnode)
